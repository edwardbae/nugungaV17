...
Router.map(function(){
    ...
    this.route('myGidoPage', {
        ...
        template: 'myGidoPage',
        data: function(){
            Session.set("pageTitle", "나의 기도"); //grabs the _id of the Posts docmument
        },
    });
    this.route('friendsGidoPage', {
        ...
        data: function(){
            Session.set("pageTitle", "친구들의 기도"); //grabs the _id of the Posts docmument
        },
    });
    this.route('allGidoPage', {
        ...
        data: function(){
            Session.set("pageTitle", "모두의 기도"); //grabs the _id of the Posts docmument
        },
    });
